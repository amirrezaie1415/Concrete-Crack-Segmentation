...
def main(config):
    ...
    for filename in filenames:
        ...
        if ext == '.png':  # input images has the extension ".png",
...
if __name__ == '__main__':
    ...
    # database path
    parser.add_argument('--origin_data_path', type=str, default='../../datasets/Concrete Crack Segmentation Dataset/treated_dataset/images')
    parser.add_argument('--origin_GT_path', type=str, default='../../datasets/Concrete Crack Segmentation Dataset/treated_dataset/masks')
